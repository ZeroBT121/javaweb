                ...
                <table border="1">
                    ...
                    <c:forEach items="${cartList}" var="cart">
                        <tr>
                            ...
                            <td><a href="${pageContext.servletContext.contextPath}${initParam.W_SERVLET_BASE}/RemoveCartServlet?id=${cart.auctionDO.id}">删除此商品</a></td>
                        </tr>

                    </c:forEach>
                    <tr>
                        <td colspan="7" align="right"><a href="${pageContext.servletContext.contextPath}${initParam.W_SERVLET_BASE}/getAllAuction">继续购物</a></td>
                    </tr>
                </table>
            </form>
        </td>
